      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-slate-600">Loading education materials...</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
            <div>
              ...
              <p className="text-slate-600">Learn about investment concepts, unit values, and club management</p>
            </div>
            <Link 
              to="/member/dashboard" 
            ...
            <div>
              ...
              <div className="flex gap-3">
                <Link 
                  ...
                  className="inline-flex items-center px-6 py-3 bg-white text-blue-600 hover:bg-slate-50 font-medium rounded-lg transition-colors whitespace-nowrap"
                >
                  Quick Start →
                </Link>
                <Link 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-6 sticky top-8">
              <h3 className="text-lg font-bold text-slate-900 mb-4">Learning Tracks</h3>
          ...
          <div className="lg:col-span-3">
            ...
            {publishedLessons.length === 0 ? (
              <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-8 text-center">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-2">No Lessons Available Yet</h3>
              ...
              <div className="space-y-6">
                ...
                {['beginner', 'intermediate', 'advanced'].map(track => {
                  ...
                  return (
                    <div key={track} className="bg-white rounded-lg shadow-sm border border-slate-200">
                      ...
                      <div className="p-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          {trackLessons.map((lesson) => (
                            <div key={lesson.id} className="border border-slate-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <Link 
                                  ...
                                  className="inline-flex items-center px-3 py-1 text-sm font-medium text-blue-600 hover:text-blue-700 hover:bg-blue-50 rounded-md transition-colors"
                                >
                                  Start Lesson →
                                </Link>
                              </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 mt-8">
              <div className="border-b border-slate-200 bg-gradient-to-r from-purple-50 to-pink-50 px-6 py-4">
                ...
                <p className="text-slate-600 text-sm mt-1">Hands-on tools to master investment concepts</p>
              </div>
              <div className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
