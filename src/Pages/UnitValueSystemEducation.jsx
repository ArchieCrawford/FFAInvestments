    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="p-6">
            <div className="text-lg leading-relaxed space-y-4">
              ...
              <div className="text-center my-6">
                <span className="inline-block bg-primary text-white px-6 py-3 rounded-full text-sm font-medium">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-border mb-8">
          ...
          <div className="p-6">
            <div className="bg-primary-soft border border-blue-200 rounded-lg p-4 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <div className="bg-bg border border-border rounded-lg p-6 text-center">
                ...
                <div className="text-2xl font-bold text-default mb-2">$913,810.31</div>
                <div className="text-sm text-muted">Total cash + all stock investments</div>
              </div>
              <div className="bg-bg border border-border rounded-lg p-6 text-center">
                <h3 className="text-sm font-medium text-blue-600 mb-2">Step 2 — Outstanding Units</h3>
                <div className="text-2xl font-bold text-default mb-2">18,175.61</div>
                <div className="text-sm text-muted">Total units distributed to all members</div>
              </div>
              <div className="bg-bg border border-border rounded-lg p-6 text-center">
                <h3 className="text-sm font-medium text-blue-600 mb-2">Step 3 — Current Unit Price</h3>
                <div className="text-2xl font-bold text-default mb-2">$50.29</div>
                <div className="text-sm text-muted">$913,810.31 ÷ 18,175.61 units</div>
              </div>
            </div>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full bg-white border border-border">
                <thead className="bg-bg">
                  <tr>
                    <th className="px-6 py-3 text-left text-xs font-medium text-muted uppercase tracking-wider">Member Name</th>
                    <th className="px-6 py-3 text-right text-xs font-medium text-muted uppercase tracking-wider">Units Owned</th>
                    <th className="px-6 py-3 text-right text-xs font-medium text-muted uppercase tracking-wider">Current Value</th>
                    <th className="px-6 py-3 text-right text-xs font-medium text-muted uppercase tracking-wider">% of Club</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-200">
                  <tr>
                    <td className="px-6 py-4 whitespace-nowrap font-medium text-default">Burrell, Felecia</td>
                    <td className="px-6 py-4 whitespace-nowrap text-right text-default">1,852.53</td>
                    <td className="px-6 py-4 whitespace-nowrap text-right font-medium text-default">$93,189.17</td>
                    <td className="px-6 py-4 whitespace-nowrap text-right text-default">10.19%</td>
                  </tr>
                  <tr>
                    <td className="px-6 py-4 whitespace-nowrap font-medium text-default">Jean, Joel Sr.</td>
                    <td className="px-6 py-4 whitespace-nowrap text-right text-default">2,231.93</td>
                    <td className="px-6 py-4 whitespace-nowrap text-right font-medium text-default">$112,268.84</td>
                    <td className="px-6 py-4 whitespace-nowrap text-right text-default">12.28%</td>
                  </tr>
                  <tr>
                    <td className="px-6 py-4 whitespace-nowrap font-medium text-default">J. Archie</td>
                    <td className="px-6 py-4 whitespace-nowrap text-right text-default">11.08</td>
                    <td className="px-6 py-4 whitespace-nowrap text-right font-medium text-default">$557.21</td>
                    <td className="px-6 py-4 whitespace-nowrap text-right text-default">0.06%</td>
                  </tr>
                </tbody>
              </table>
            </div>
            
            <div className="bg-primary-soft border border-blue-200 rounded-lg p-4 mt-6">
              <p className="text-blue-800">
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="bg-bg border border-border rounded-lg p-6">
                <h3 className="text-lg font-medium text-default mb-4">💵 Making a Deposit</h3>
                <p className="font-medium mb-3">Process:</p>
                <ol className="list-decimal list-inside space-y-2 text-default">
                  <li>Member brings cash to invest</li>
                  <li>Calculate: <code className="bg-surface px-2 py-1 rounded text-sm">New Units = Cash ÷ Current Unit Price</code></li>
              ...
              <div className="bg-bg border border-border rounded-lg p-6">
                <h3 className="text-lg font-medium text-default mb-4">💸 Making a Withdrawal</h3>
                <p className="font-medium mb-3">Process:</p>
                <ol className="list-decimal list-inside space-y-2 text-default">
                  <li>Member wants to cash out units</li>
                  <li>Calculate: <code className="bg-surface px-2 py-1 rounded text-sm">Cash Payout = Units × Current Unit Price</code></li>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-border mb-8">
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div>
                <label className="block text-sm font-medium text-default mb-2">Total Portfolio Value ($)</label>
                <input 
                  type="number" 
                  step="0.01" 
              ...
              <div>
                <label className="block text-sm font-medium text-default mb-2">Total Units Outstanding</label>
                <input 
                  type="number" 
                  step="0.01" 
                  value={totalUnits}
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              <div className="text-center p-4 bg-bg border border-border rounded-lg">
                <div className="text-xs uppercase tracking-wider text-muted mb-1">Current Unit Price</div>
                <div className="text-lg font-bold text-default">${formatMoney(unitPrice)}</div>
                <div className="text-xs text-muted">Portfolio ÷ Units</div>
              </div>
              <div className="text-center p-4 bg-bg border border-border rounded-lg">
                <div className="text-xs uppercase tracking-wider text-muted mb-1">Archie's Value</div>
                <div className="text-lg font-bold text-default">${formatMoney(11.08 * unitPrice)}</div>
                <div className="text-xs text-muted">11.08 units × price</div>
              </div>
              <div className="text-center p-4 bg-bg border border-border rounded-lg">
                <div className="text-xs uppercase tracking-wider text-muted mb-1">Total Portfolio</div>
                <div className="text-lg font-bold text-default">${formatMoney(portfolioValue)}</div>
              </div>
              <div className="text-center p-4 bg-bg border border-border rounded-lg">
                <div className="text-xs uppercase tracking-wider text-muted mb-1">Total Units</div>
                <div className="text-lg font-bold text-default">{totalUnits.toFixed(2)}</div>
              </div>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                <h4 className="text-lg font-medium text-default mb-4">💵 Try a Member Deposit</h4>
                <input 
                  type="number" 
                  step="0.01" 
                ...
                {addNote && (
                  <div className="mt-3 p-3 bg-primary-soft border border-blue-200 rounded text-sm text-blue-800">
                    {addNote}
                  </div>
                )}
              </div>
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-6">
                <h4 className="text-lg font-medium text-default mb-4">💸 Try a Member Withdrawal</h4>
                <input 
                  type="number" 
                  step="0.01" 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-bg border border-border rounded-lg p-6">
                <h4 className="text-lg font-medium text-default mb-4">📊 Direct Unit Transfer</h4>
                <input 
                  type="number" 
                  step="0.01" 
              ...
              <div className="bg-bg border border-border rounded-lg p-6">
                <h4 className="text-lg font-medium text-default mb-4">🔄 Reset Controls</h4>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-border">
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="bg-bg border border-border rounded-lg p-6">
                <h3 className="text-lg font-medium text-default mb-4">🔹 For New Members</h3>
              ...
              <div className="bg-bg border border-border rounded-lg p-6">
                <h3 className="text-lg font-medium text-default mb-4">🔹 For Existing Members</h3>
                <ul className="list-disc list-inside space-y-2 text-default">
              ...
              <div className="bg-bg border border-border rounded-lg p-6">
                <h3 className="text-lg font-medium text-default mb-4">🔹 Price Movement Rules</h3>
                <ul className="list-disc list-inside space-y-2 text-default">
              ...
              <div className="bg-bg border border-border rounded-lg p-6">
                <h3 className="text-lg font-medium text-default mb-4">🔹 Fairness Guarantees</h3>
                <ul className="list-disc list-inside space-y-2 text-default">
