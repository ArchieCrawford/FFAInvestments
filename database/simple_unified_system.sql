-- SIMPLIFIED UNIFIED MEMBER SYSTEM SETUP
-- This avoids JSONB operations that were causing the error
...
-- 2. Insert your 22 club members (with unique member_name field)
INSERT INTO members (email, member_name, full_name, first_name, last_name, membership_status) VALUES
  ...
  ('donotreply.resumebuilder@asamra.hoffman.army.mil', 'Asamra Hoffman', 'Asamra Hoffman Army Donotreply.resumebuilder', 'Asamra', 'Hoffman', 'active'),
...
ON CONFLICT (email) DO UPDATE SET
  member_name = COALESCE(EXCLUDED.member_name, members.member_name),
